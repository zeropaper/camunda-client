...
define('search-view',['backbone'], function(Backbone) {
  var View = Backbone.View.extend({});
  return View;
});
define('tasks-view',['backbone'], function(Backbone) {
  var View = Backbone.View.extend({});
  return View;
});
define('task-details-view',['backbone'], function(Backbone) {
  var View = Backbone.View.extend({});
  return View;
});
/*
...
define('tasks-collection',['backbone-pageable'], function(PageableCollection) {
...
define('camunda-client', [
  ...
  var App = Backbone.Router.extend({
    ...
    initialize: function() {
      ...
      this.detailsView = new TasksView({
        model: new TasksCollection.prototype.model({})
      });
